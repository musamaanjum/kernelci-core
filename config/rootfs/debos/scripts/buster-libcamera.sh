...
After removing libgtest-dev, libcamera is not being built using qemu 6 on Bullseye
this commit reverts the code from libcamera to the point that is working.
'
